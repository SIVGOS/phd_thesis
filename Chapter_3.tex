...
\blfootnote{\textbf{Publication:} S. Goswami, K. Sarmah, and K. K. Sarma, ``Simulation-Driven Optimization of Slot Antenna Using Genetic Algorithm,'' in \emph{Planar Antenna - Design, Fabrication, Testing, and Application}, Nova Science Publishers, Inc., USA, 2021.}
\label{chap:chap3}
