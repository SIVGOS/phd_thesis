...
\blfootnote{\textbf{Publication:}\\ {\footnotesize S. Goswami, K. Sarmah, P. Borah, and K. K. Sarma, ``Design of a dual-band multilayer antenna and its equivalent circuit modeling with vector-fitting and genetic algorithm,'' \emph{AEUE - International Journal of Electronics and Communications}, vol. 138, p. 153838, Aug. 2021, doi: 10.1016/j.aeue.2021.153838.}}
\label{chap:chap4}
...
%The capacitor represents the physical separation between the two branches.
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=0.4\linewidth]{Fig-aeue_2a.eps}}~~~~
\subfigure[]{\includegraphics[width=0.6\linewidth]{Fig-aeue_2b.eps}}
...
\subsubsection{Analysis of the Equivalent Circuit Model with Vector Fitting Technique}
...
\subfigure[]{\includegraphics[width=0.3\linewidth]{Fig-aeue_4b.eps}}~~~
\subfigure[]{\includegraphics[width=0.3\linewidth]{Fig-aeue_4c.eps}}
